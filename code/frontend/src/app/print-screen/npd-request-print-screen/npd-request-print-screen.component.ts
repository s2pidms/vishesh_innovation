...
@Component({
    ...
    templateUrl: "./npd-request-print-screen.component.html",
    styleUrls: ["./npd-request-print-screen.component.scss"]
})
export class NPDRequestPrintScreenComponent implements OnInit {
    @Input() NPDId: string = "";
    ...
    create(formData: any) {
        ...
        this.npdRequestService.create(formData).subscribe(success => {
            ...
            this.router.navigate(["/default/business-leads/transactions/npd-request/list"]);
        });
    }
