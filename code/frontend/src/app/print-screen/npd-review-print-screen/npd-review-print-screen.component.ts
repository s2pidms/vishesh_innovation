...
@Component({
    selector: "app-npd-review-print-screen",
    templateUrl: "./npd-review-print-screen.component.html",
    styleUrls: ["./npd-review-print-screen.component.scss"]
})
export class NPDReviewPrintScreenComponent implements OnInit {
