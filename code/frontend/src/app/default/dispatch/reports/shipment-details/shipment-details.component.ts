...
import {
    SHIPMENT_DETAILS_PDF_DATA,
    SHIPMENT_DETAILS_REPORT_DATA
} from "@mocks/export-data/dispatch/reports/shipmentDetailsReport";
import {ShipmentDetails} from "@mocks/models/dispatch/reports";
...
export class ShipmentDetailsComponent implements OnInit, OnDestroy {
    ...
    pdfDownload(data: any) {
        let output = SHIPMENT_DETAILS_PDF_DATA(data);
        this.exportToPDFService.generatePdf(output.tableData, output.title);
    }

    excelDownload(data: any) {
        this.exportExcelService.exportExcel(SHIPMENT_DETAILS_REPORT_DATA(data));
    }
