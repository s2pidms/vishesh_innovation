...
import {DRN_SUMMARY_PDF_DATA, DRN_SUMMARY_REPORT_DATA} from "@mocks/export-data/dispatch/reports/DRNSummaryReport";
...
@Component({
    selector: "app-drn-summary",
    templateUrl: "./drn-summary.component.html"
})
export class DRNSummaryComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.dispatchRequestNoteService.getAllDRNSummaryReports(payload).subscribe(success => {
            if (flag == "EXCEL") {
                ...
                this.customersOptions = success.customerList;
    ...
    pdfDownload(data: any) {
        let output = DRN_SUMMARY_PDF_DATA(data);
        this.exportToPDFService.generatePdf(output.tableData, output.title);
    }

    excelDownload(data: any) {
        this.exportExcelService.exportExcel(DRN_SUMMARY_REPORT_DATA(data));
    }
