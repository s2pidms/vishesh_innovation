...
import {
    SUPPLIER_EVALUATION_MASTER_REPORT_DATA,
    SUPPLIER_EVALUATION_MASTER_PDF_DATA
} from "@mocks/export-data/purchase/master";
import {SupplierEvaluation} from "@mocks/models/purchase/masters";
import {NgbModal} from "@ng-bootstrap/ng-bootstrap";
import {ConfirmDeleteComponent} from "@shared/modals";

@Component({
    selector: "app-supplier-evaluation-list",
    templateUrl: "./supplier-evaluation-list.component.html"
})
export class SupplierEvaluationListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.supplierEvaluationService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    delete(id: any) {
        this.spinner.show();
        this.supplierEvaluationService.delete(id).subscribe(success => {
            this.spinner.hide();
    ...
    openConfirmModal(id: any, code: any) {
        ...
        modalRef.componentInstance.confirmText = `Confirm Deletion of Name ${code} ?`;
    ...
    excelDownload(data: any) {
        this.exportExcelService.exportExcel(SUPPLIER_EVALUATION_MASTER_REPORT_DATA(data));
    }

    pdfDownload(data: any) {
        let output = SUPPLIER_EVALUATION_MASTER_PDF_DATA(data);
