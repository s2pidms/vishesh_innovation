...
import {PPV_DETAILS_PDF_DATA, PPV_DETAILS_REPORT_DATA} from "@mocks/export-data/purchase/reports";
import {PPVDetails} from "@mocks/models/purchase/reports";

@Component({
    selector: "app-ppv-details",
    templateUrl: "./ppv-details.component.html"
})
export class PPVDetailsComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.purchaseService.getAllPPVDetailsReports(payload).subscribe(success => {
            if (flag == "EXCEL") {
                ...
                this.suppliers = success.suppliers;
    ...
    pdfDownload(data: any) {
        let output = PPV_DETAILS_PDF_DATA(data);
        this.exportToPDFService.generatePdf(output.tableData, output.title);
    }

    excelDownload(data: any) {
        this.exportExcelService.exportExcel(PPV_DETAILS_REPORT_DATA(data));
    }
