...
@Component({
    selector: "app-view-sku-dimension",
    templateUrl: "./view-sku-dimension.component.html",
    styleUrls: ["./view-sku-dimension.component.scss"]
})
export class ViewSkuDimensionComponent implements OnInit {
    @Input() action: any = "";
