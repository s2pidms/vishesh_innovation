...
import {FgInventoryModalComponent, JobCardDispModalComponent} from "../../../../job-card/screens/components";
import {ViewSkuDimensionComponent} from "../../../../job-card/screens/components/view-sku-dimension/view-sku-dimension.component";

@Component({
    selector: "app-so-sku-details",
    templateUrl: "./so-sku-details.component.html",
    styles: [
        `
            .box {
                display: grid;
...
export class SoSkuDetailsComponent implements OnInit {
