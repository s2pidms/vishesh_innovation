...
@Component({
    selector: "app-copy-dimension-master-modal",
    templateUrl: "./copy-dimension-master-modal.component.html",
    styleUrls: ["./copy-dimension-master-modal.component.scss"]
})
export class CopyDimensionMasterModalComponent implements OnInit {
    ...
    dismissModel() {
        ...
        this.spinner.show();
        this.skuService.createCopyForSKUDimAttributes(payload).subscribe(success => {
