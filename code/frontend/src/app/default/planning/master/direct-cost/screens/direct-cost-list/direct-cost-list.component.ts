...
import {DIRECT_COST_PDF_DATA, DIRECT_COST_REPORT_DATA} from "@mocks/export-data/planning/master";
import {DirectCost} from "@mocks/models/planning/masters";
import {ConfirmDeleteComponent} from "@shared/modals";
import {NgbModal} from "@ng-bootstrap/ng-bootstrap";
@Component({
    selector: "app-direct-cost-list",
    templateUrl: "./direct-cost-list.component.html"
})
export class DirectCostListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.directCostService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    pdfDownload(data: any) {
        let outPut = DIRECT_COST_PDF_DATA(data);
        this.exportToPDFService.generatePdf(outPut.tableData, outPut.title);
    }
    excelDownload(data: any) {
        this.exportExcelService.exportExcel(DIRECT_COST_REPORT_DATA(data));
    }
    ...
    delete(id: any) {
        this.spinner.show();
        this.directCostService.delete(id).subscribe(success => {
            this.spinner.hide();
