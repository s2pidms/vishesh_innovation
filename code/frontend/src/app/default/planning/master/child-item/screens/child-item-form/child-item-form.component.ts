...
import {ChildItemSupplierModalComponent} from "../child-item-supplier-modal/child-item-supplier-modal.component";
...
@Component({
    selector: "app-child-item-form",
    templateUrl: "./child-item-form.component.html"
})
export class ChildItemFormComponent implements OnInit {
    ...
    getInitialData() {
        ...
        this.childItemsService.getAllMasterData({}).subscribe(result => {
            ...
            this.form.controls["childItemCategory"].setValue("L20/Child Item");
            this.form.controls["itemCode"].setValue(this.autoIncValues["L20/Child Item"]);
