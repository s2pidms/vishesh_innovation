...
import {ProductMaster} from "@mocks/models/planning/masters";
...
export class ProductMasterListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.productMasterService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    excelDownload(data: any) {
        this.exportExcelService.exportExcel(PRODUCT_MASTER_REPORT_DATA(data));
    }

    pdfDownload(data: any) {
        let output = PRODUCT_MASTER_PDF_DATA(data);
    ...
    delete(id: any) {
        this.spinner.show();
        this.productMasterService.delete(id).subscribe(success => {
            this.spinner.hide();
    ...
    openConfirmModal(id: any, code: any) {
        ...
        modalRef.componentInstance.confirmText = `Confirm Deletion of Product No. ${code} ?`;
