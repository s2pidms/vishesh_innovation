...
@Component({
    selector: "app-copy-ink-ink-info-modal",
    templateUrl: "./copy-ink-ink-info-modal.component.html",
    styleUrls: ["./copy-ink-ink-info-modal.component.scss"]
})
export class CopyInkInkInfoModalComponent implements OnInit {
    ...
    dismissModel() {
        ...
        this.spinner.show();
        this.skuService.createCopyForSKUInkAttributes(payload).subscribe(success => {
