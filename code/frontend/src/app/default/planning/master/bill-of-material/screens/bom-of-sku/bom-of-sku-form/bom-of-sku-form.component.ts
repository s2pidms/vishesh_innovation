...
import {BOM_OF_SKU_FORM_REPORT_DATA} from "@mocks/export-data/planning/master";
import {BOMOfSKUMasterData} from "@mocks/models/planning/masters";

@Component({
    selector: "app-bom-of-sku-form",
    templateUrl: "./bom-of-sku-form.component.html",
    styles: [
        `
            .blueColor {
                color: #0000ff;
...
export class BomOfSkuFormComponent implements OnInit {
    ...
    eventHeader(event: any) {
        switch (event.key) {
            ...
            case "EXCEL":
                ...
                this.exportExcelService.exportExcel(BOM_OF_SKU_FORM_REPORT_DATA(data));
                break;
            case "PAGE":
