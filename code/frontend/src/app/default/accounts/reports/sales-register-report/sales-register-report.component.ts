...
import {LIST_DEFAULT_PERMISSION_ACTIONS, SALES_REGISTER_REPORT_NAME} from "@mocks/constant";
import {
    AppGlobalService,
    ExportExcelService,
    ExportToPDFService,
...
import {SALES_REGISTER_REPORT_PDF_DATA, SALES_REGISTER_REPORT_REPORT_DATA} from "@mocks/export-data/accounts/reports";

@Component({
    selector: "app-sales-register-report",
    templateUrl: "./sales-register-report.component.html"
})
export class SalesRegisterReportComponent implements OnInit, OnDestroy {
    ...
    toDate: string = "";
    fromDate: string = "";
    reportNameObj: any = SALES_REGISTER_REPORT_NAME;
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.salesInvoiceService.getAllSalesRegisterReports(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    pdfDownload(data: any) {
        let outPut = SALES_REGISTER_REPORT_PDF_DATA(data);
        this.exportToPDFService.generatePdf(outPut.tableData, outPut.title);
    }

    excelDownload(data: any) {
        this.exportExcelService.exportExcel(SALES_REGISTER_REPORT_REPORT_DATA(data));
    }
