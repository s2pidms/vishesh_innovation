...
import {TravelRequest} from "@mocks/models/accounts/transactions";

@Component({
    selector: "app-travel-request-list",
    templateUrl: "./travel-request-list.component.html"
})
export class TravelRequestListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.travelRequestService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
