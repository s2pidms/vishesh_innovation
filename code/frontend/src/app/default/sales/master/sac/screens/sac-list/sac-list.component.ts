...
import {SAC_MASTER_PDF_DATA, SAC_MASTER_REPORT_DATA} from "@mocks/export-data/sales/master";
import {salesSAC} from "@mocks/models/sales/master/salesSAC";
...
export class SACListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.salesSACService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    delete(id: any) {
        this.spinner.show();
        this.salesSACService.delete(id).subscribe(success => {
            this.spinner.hide();
