...
export class CreditNoteSummaryComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false) {
        ...
        this.subscription = this.creditNoteService.getAllCNSummaryReports(payload).subscribe(success => {
            if (excel) {
    ...
    excelDownload(data: any) {
        ...
        let reportData: any = {
            ...
            headers: [
                ...
                {
                    header: "Total Credit Notes",
                    key: "totalCreditNotes",
                    ...style
                },
                {
                    header: "Total Amount Credited",
