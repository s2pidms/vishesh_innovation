...
import {EInvoiceValueDetailsComponent} from "../../../generate-e-invoice/screens/e-invoice-value-details/e-invoice-value-details.component";
import {EInvoiceItemDetailsComponent} from "../../../generate-e-invoice/screens/e-invoice-item-details/e-invoice-item-details.component";
import {EInvoiceDispatchShipDetailsComponent} from "../../../generate-e-invoice/screens/e-invoice-dispatch-ship-details/e-invoice-dispatch-ship-details.component";
import {GENERATE_EXPORT_E_iNVOICE_SUP_TYPE} from "@mocks/options.constant";

@Component({
    selector: "app-generate-export-e-invoice-form",
    templateUrl: "./generate-export-e-invoice-form.component.html"
})
export class GenerateExportEInvoiceFormComponent implements OnInit {
    ...
    form: any = new UntypedFormGroup({
        ...
        TranDtls: new UntypedFormGroup({
            ...
            SupTyp: new UntypedFormControl("EXPWOP"),
    ...
    getInitialData() {
        this.spinner.show();
        this.salesInvoiceService.getAllEwayBillList({category: "Exports", type: "EInvoice"}).subscribe(success => {
    ...
    setSalesInvoice(eve: any) {
        ...
        this.salesInvoiceService.getById(eve._id).subscribe(success => {
            ...
            this.itemDetailsArr = success?.salesInvoiceDetails.map((x: any, index: any) => {
                let TotItemVal = +x?.salesInvoiceLineValue;
                return {
                    SlNo: index + 1,
                    IsServc: "N",
                    HsnCd: x?.SKU?.hsn,
            ...
            let obj = {
                ...
                BuyerDtls: {
                    ...
                    Pin: 999999 || +success?.customerBillingAddress?.pinCode,
                    Stcd: "96" || success?.customer?.GSTIN.slice(0, 2),
                    Pos: "96" || success?.customer?.GSTIN.slice(0, 2)
                },
                ...
                ShipDtls: {
                    ...
                    Pin: 999999 || +success?.customerShippingAddress?.pinCode,
                    Stcd: "96" || success?.customer?.GSTIN.slice(0, 2)
                }
            };
