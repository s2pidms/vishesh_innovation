...
@Component({
    selector: "app-cancel-drn",
    templateUrl: "./cancel-drn.component.html"
})
export class CancelDrnComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.dispatchRequestNoteService.getAllForCancel(payload).subscribe(success => {
            if (flag == "EXCEL") {
