...
import {ViewNpdRequestDetailsComponent} from "../../../npd-request/screens/view-npd-request-details/view-npd-request-details.component";
...
import {NPDDetailsModalComponent} from "../components/npd-details-modal/npd-details-modal.component";
import {Location} from "@angular/common";

@Component({
    selector: "app-review-feasibility-form",
    templateUrl: "./review-feasibility-form.component.html",
    styleUrls: ["./review-feasibility-form.component.scss"]
})
export class ReviewFeasibilityFormComponent implements OnInit {
