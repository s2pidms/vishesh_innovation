...
@Component({
    selector: "app-cost-sheet-for-dsku-details",
    templateUrl: "./cost-sheet-for-dsku-details.component.html",
    styles: [
        `
            .form-control-cd-sm {
                margin: 0 !important;
...
export class CostSheetForDskuDetailsComponent implements OnInit {
