...
@Component({
    selector: "app-copy-process-flow-modal",
    templateUrl: "./copy-process-flow-modal.component.html",
    styleUrls: ["./copy-process-flow-modal.component.scss"]
})
export class CopyProcessFlowModalComponent implements OnInit {
    ...
    dismissModel() {
        ...
        this.spinner.show();
        this.skuProcessFlowService.createCopy(payload).subscribe(success => {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.skuProcessFlowService.getAllCopyFlowMasterData(payload).subscribe(success => {
            this.tableData = success?.SKUList;
            this.originTableData = success?.SKUList;
            this.productCategories = success?.productCategoryOptions;
