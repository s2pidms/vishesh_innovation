...
export class DiscrepancyListComponent implements OnInit, OnDestroy {
    ...
    navigateTo(path: string, item: any, action: string) {
        if (item.GIStatus == "Discrepancy Resolved" && action == "viewDSCR") {
            return null;
        } else {
