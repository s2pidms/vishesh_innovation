...
import {IPQAModalComponent, ProdInfoModalComponent} from "../components";
import {JCBatchInfoModalComponent} from "../components/jc-batch-info-modal/jc-batch-info-modal.component";
import {NgbdSortableHeader, SortEvent} from "@shared/directives";

@Component({
    selector: "app-job-card-entry-form",
    templateUrl: "./job-card-entry-form.component.html"
})
export class JobCardEntryFormComponent implements OnInit {
    ...
    create(formData: any) {
        this.spinner.show();
        this.jobCardEntryService.create(formData).subscribe(success => {
    ...
    update(formData: any) {
        this.spinner.show();
        this.jobCardEntryService.update(formData._id, formData).subscribe(success => {
            this.spinner.hide();
            this.submitted = false;
            this.toastService.success(success.message);
            this.location.back();
