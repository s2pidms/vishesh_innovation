...
@Component({
    selector: "app-child-part-production",
    templateUrl: "./child-part-production.component.html"
})
export class ChildPartProductionComponent implements OnInit {
    constructor(
    ...
    getAll() {
        ...
        this.subModulesService.getAll(payload).subscribe(success => {
            this.cards = success?.rows.find((x: any) => x.title == "Production Entry");
