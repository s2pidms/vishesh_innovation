...
@Component({
    selector: "app-jc-entry-list",
    templateUrl: "./jc-entry-list.component.html"
})
export class JcEntryListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.jcEntryService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
