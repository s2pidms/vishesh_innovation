...
@Component({
    selector: "app-ipqa-log-model",
    templateUrl: "./ipqa-log-model.component.html",
    styleUrls: ["./ipqa-log-model.component.scss"]
})
export class IpqaLogModelComponent implements OnInit {
