...
@Component({
    selector: "app-screen-printing-log-entry",
    templateUrl: "./screen-printing-log-entry.component.html"
})
export class ScreenPrintingLogEntryComponent implements OnInit {
