...
import {GR_FULFILLMENT_PDF_DATA, GR_FULFILLMENT_REPORT_DATA} from "@mocks/export-data/hr/reports";
import {GRFulfillmentStatus} from "@mocks/models/hr&Admin/reports";
...
export class GrFulfillmentStatusComponent implements OnInit, OnDestroy {
    ...
    pdfDownload(data: any) {
        let outPut = GR_FULFILLMENT_PDF_DATA(data);
        this.exportToPDFService.generatePdf(outPut.tableData, outPut.title);
    }

    excelDownload(data: any) {
        this.exportExcelService.exportExcel(GR_FULFILLMENT_REPORT_DATA(data));
    }
