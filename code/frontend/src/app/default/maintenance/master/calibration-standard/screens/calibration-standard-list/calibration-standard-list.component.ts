...
@Component({
    ...
    templateUrl: "./calibration-standard-list.component.html"
})
export class CalibrationStandardListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.calibrationStandardService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    excelDownload(data: any) {
        this.exportExcelService.exportExcel(CALIBRATION_STANDARD_MASTER_REPORT_DATA(data));
    }

    pdfDownload(data: any) {
        let output = CALIBRATION_STANDARD_MASTER_PDF_DATA(data);
