...
import {IProductCategory} from "@mocks/models/settings/masters";
import {ProductCategoryMasterService} from "@services/settings/productCategoryMaster.service";
import {
    PRODUCT_CATEGORY_PDF_DATA,
    PRODUCT_CATEGORY_REPORT_DATA
} from "@mocks/export-data/settings/masters/productCategory";
...
export class ProductCategoryListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.productCategoryMasterService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    pdfDownload(data: any) {
        let outPut = PRODUCT_CATEGORY_PDF_DATA(data);
    ...
    excelDownload(data: any) {
        ...
        this.exportExcelService.exportExcel(PRODUCT_CATEGORY_REPORT_DATA(data));
    }
