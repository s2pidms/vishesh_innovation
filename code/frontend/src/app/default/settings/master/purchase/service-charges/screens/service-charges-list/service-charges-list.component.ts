...
import {
    SERVICE_CHARGES_PDF_DATA,
    SERVICE_CHARGES_REPORT_DATA
} from "@mocks/export-data/settings/masters/servicesCharges";

@Component({
    selector: "app-service-charges-list",
    templateUrl: "./service-charges-list.component.html"
})
export class ServiceChargesListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false, flag = "") {
        ...
        this.subscription = this.servicesChargesService.getAll(payload).subscribe(success => {
            if (flag == "EXCEL") {
    ...
    pdfDownload(data: any) {
        let outPut = SERVICE_CHARGES_PDF_DATA(data);
        this.exportToPDFService.generatePdf(outPut.tableData, outPut.title);
    }
    excelDownload(data: any) {
        this.exportExcelService.exportExcel(SERVICE_CHARGES_REPORT_DATA(data));
    }
