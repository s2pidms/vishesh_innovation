...
@Component({
    selector: "app-business-lead-master",
    templateUrl: "./business-lead-master.component.html"
})
export class BusinessLeadMasterComponent implements OnInit {
    constructor(
    ...
    getAll() {
        ...
        this.subModulesService.getAll(payload).subscribe(success => {
            this.cards = success?.rows.find((x: any) => x.title == "Business Leads Master");
