...
export class MailConfigurationListComponent implements OnInit, OnDestroy {
    ...
    getAll(excel = false) {
        ...
        this.subscription = this.mailConfigurationService.getAll(payload).subscribe(success => {
            if (excel) {
