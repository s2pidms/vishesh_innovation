...
import {ExportExcelService, SpinnerService, StorageService} from "@core/services";
...
export class ModuleMasterListComponent implements OnInit {
    ...
    getAll(excel = false) {
        ...
        this.moduleMasterService.getAll(payload).subscribe(success => {
            if (excel) {
