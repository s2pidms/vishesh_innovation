...
export class DirectTaxInvoiceService {
    routes: any = {
        ...
        getByIdForPDFPath: (id: string) => `/sales/directTaxInvoice/getByIdForPDF/${id}`,
        getDTIDetailsByCustomerIdPath: (id: string) => `/sales/directTaxInvoice/getDTIDetailsByCustomerId/${id}`
    };
    ...
    getDTIDetailsByCustomerId(id: string) {
        return this.http.get(this.routes.getDTIDetailsByCustomerIdPath(id)).pipe(map((res: any) => res));
    }
    getById(id: string) {
