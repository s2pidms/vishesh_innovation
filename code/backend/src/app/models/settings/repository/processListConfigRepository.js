const Model = require("../processListConfigModel");
const ProcessListConfigRepository = {
    createDoc: async obj => {
    ...
    filteredProcessListConfigList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = ProcessListConfigRepository;
