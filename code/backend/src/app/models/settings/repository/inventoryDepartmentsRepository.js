const Model = require("../inventoryDepartmentsModel");
const InventoryDepartmentsRepository = {
    createDoc: async obj => {
    ...
    filteredInventoryDepartmentsList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = InventoryDepartmentsRepository;
