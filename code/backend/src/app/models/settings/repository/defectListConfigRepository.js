const Model = require("../defectListConfigModel");
const DefectListConfigRepository = {
    createDoc: async obj => {
    ...
    filteredDefectListConfigList: async pipeline => {
        return await Model.aggregate(pipeline);
    }
};
module.exports = DefectListConfigRepository;
